...
class CardInfoApi
{
     ...
     *
     * @param  \Cardpay\model\CardInfoRequest $card_info_request cardInfoRequest (required)
     *
    ...
    {
        list($response) = $this->cardInfoWithHttpInfo($card_info_request);
        return $response;
    }

    /**
     * Operation cardInfoWithHttpInfo
     *
     * Get card information
     *
     * @param  \Cardpay\model\CardInfoRequest $card_info_request cardInfoRequest (required)
     ...
     */
    public function cardInfoAsync($card_info_request)
    {
        return $this->cardInfoAsyncWithHttpInfo($card_info_request)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation cardInfoAsyncWithHttpInfo
     *
     * Get card information
     *
     * @param  \Cardpay\model\CardInfoRequest $card_info_request cardInfoRequest (required)
    ...
    /**
     * Create request for operation 'cardInfo'
     *
     * @param  \Cardpay\model\CardInfoRequest $card_info_request cardInfoRequest (required)
     *
     * @throws \InvalidArgumentException
     ...
     */
    protected function cardInfoRequest($card_info_request)
    {
        // verify the required parameter 'card_info_request' is set
        if ($card_info_request === null || (is_array($card_info_request) && count($card_info_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $card_info_request when calling cardInfo'
            );
        }

        $resourcePath = '/api/card_info';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // body params
        $_tempBody = null;
        if (isset($card_info_request)) {
            $_tempBody = $card_info_request;
        }
